...
function Skills() {
  return (
    <div>
      <section
        id="skills"
        className="bg-blue-950 shadow-lg rounded-2xl p-5 text-white "
      >
        ...
        <div className="grid lg:grid-cols-4 gap-3 md:grid-cols-2">
          <div>
            ...
            <ul>
              <li className="flex items-center py-1">
                <span className="bg-yellow-600 rounded-md mr-2">⚡</span>{" "}
                JavaScript
              </li>
              <li className="flex items-center py-1">
          ...
          <div>
            ...
            <ul>
              ...
              <li className="flex items-center py-1">
                <span className="bg-red-500 rounded-md mr-2">🚀</span>{" "}
                Express.js
              </li>
              <li className="flex items-center py-1">
          ...
          <div>
            ...
            <ul>
              <li className="flex items-center py-1">
                <span className="bg-blue-800 rounded-md mr-2">✔️</span> Team
                Collaboration
              </li>
              <li className="flex items-center py-1">
                <span className="bg-blue-200 rounded-md mr-2">✔️</span>{" "}
                Communication
              </li>

              <li className="flex items-center py-1">
                <span className="bg-blue-500 rounded-md mr-2">✔️</span> Problem
                Solving
              </li>
            </ul>
          </div>
